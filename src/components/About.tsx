      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 rounded-xl bg-purple-600 text-white text-center shadow-lg">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-gray-200 p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Dedication to Risk-Free Entertainment</h3>
            ...
            <div className="bg-gray-200 p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Strictly for Adult Gaming (18+)</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-gray-200 p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Unwavering Data Security and GDPR</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gray-800 text-white rounded-xl p-6 shadow-xl">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="md:text-right">
                <p className="mb-1">Email for Inquiries: <span className="font-semibold">meister@gmail.com</span></p>
