        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-800 space-y-8 text-gray-200 text-lg">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">🧾 1. Non-Personal and Anonymous Data Collection</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">🍪 2. Cookie Usage and Analytics</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">🧠 3. Data Storage, Security, and GDPR</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">🧑‍⚖️ 4. Your Rights Under the GDPR</h2>
